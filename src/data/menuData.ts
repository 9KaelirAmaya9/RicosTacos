...
export const menuItems: MenuItem[] = [
  ...
  { id: "d01", name: "Desayuno Ricos Tacos", description: "Eggs any style with tortillas, rice, beans and your choice of meat", price: 16.00, category: "Desayunos Mexicanos", topCategory: "Breakfast", subcategory: "Traditional Breakfast", image: tortaJamonHuevo },
  ...
  { id: "m2", name: "Bistec", description: "Grilled beef steak, seasoned simply to let the flavor shine", price: 5.00, category: "Carnes/Meats", topCategory: "Meats & Proteins", subcategory: "Beef", image: bistecTaco },
  { id: "m3", name: "Carnitas", description: "Crispy-edged, melt-in-your-mouth fried pork, the ultimate comfort", price: 5.00, category: "Carnes/Meats", topCategory: "Meats & Proteins", subcategory: "Pork", image: carnitasTaco, bestSeller: true },
  { id: "m4", name: "Cecina", description: "Thin-sliced salted beef, grilled to smoky perfection", price: 5.00, category: "Carnes/Meats", topCategory: "Meats & Proteins", subcategory: "Beef", image: cecinaTaco },
  { id: "m5", name: "Pollo Asado", description: "Smoky grilled chicken with char-kissed perfection", price: 5.00, category: "Carnes/Meats", topCategory: "Meats & Proteins", subcategory: "Chicken", image: polloAsadoTaco },
  { id: "m6", name: "Lengua", description: "Tender, melt-in-your-mouth beef tongue, seasoned to perfection", price: 5.00, category: "Carnes/Meats", topCategory: "Meats & Proteins", subcategory: "Specialty Cuts", image: lenguaTaco },
  { id: "m7", name: "Cabeza", description: "Succulent beef head meat, incredibly tender and flavorful", price: 5.00, category: "Carnes/Meats", topCategory: "Meats & Proteins", subcategory: "Specialty Cuts", image: cabezaTaco },
  { id: "m8", name: "Suadero", description: "Tender beef brisket, slow-cooked until it falls apart", price: 5.00, category: "Carnes/Meats", topCategory: "Meats & Proteins", subcategory: "Beef", image: suaderoTaco },
  { id: "m9", name: "Tripa", description: "Crispy, golden-fried beef tripe with a satisfying crunch", price: 5.00, category: "Carnes/Meats", topCategory: "Meats & Proteins", subcategory: "Specialty Cuts", image: tripaTaco },
  { id: "m10", name: "Buche", description: "Tender pork stomach, crispy outside and soft inside", price: 5.00, category: "Carnes/Meats", topCategory: "Meats & Proteins", subcategory: "Specialty Cuts", image: bucheTaco },
  { id: "m11", name: "Enchilada", description: "Zesty, chile-marinated spicy pork with a kick", price: 5.00, category: "Carnes/Meats", topCategory: "Meats & Proteins", subcategory: "Pork", image: enchiladaTaco },
  { id: "m12", name: "Longaniza", description: "Savory Mexican pork sausage with aromatic spices", price: 5.00, category: "Carnes/Meats", topCategory: "Meats & Proteins", subcategory: "Pork", image: longanizaTaco },
  { id: "m13", name: "Cueritos", description: "Tangy pickled pork skin with a delightful texture", price: 5.00, category: "Carnes/Meats", topCategory: "Meats & Proteins", subcategory: "Specialty Cuts", image: cueritosTaco },
  { id: "m14", name: "Picadillo de Res", description: "Hearty ground beef stew with potatoes and warm spices", price: 5.00, category: "Carnes/Meats", topCategory: "Meats & Proteins", subcategory: "Beef", image: picadilloTaco },
  ...
  { id: "ts1", name: "Birria", description: "Rich braised beef on crispy tortilla with fresh toppings", price: 4.00, category: "Tostadas", topCategory: "Tacos & Wraps", subcategory: "Tostadas", image: birriaTostada },
  { id: "ts2", name: "Al Pastor", description: "Marinated pork with pineapple on a crunchy base", price: 4.00, category: "Tostadas", topCategory: "Tacos & Wraps", subcategory: "Tostadas", image: pastorTostada },
  { id: "ts3", name: "Lengua", description: "Tender beef tongue with beans, lettuce, and cream", price: 4.00, category: "Tostadas", topCategory: "Tacos & Wraps", subcategory: "Tostadas", image: lenguaTostada },
  { id: "ts4", name: "Cabeza", description: "Succulent beef head meat, layered with fresh ingredients", price: 4.00, category: "Tostadas", topCategory: "Tacos & Wraps", subcategory: "Tostadas", image: cabezaTostada },
  { id: "ts5", name: "Carnitas", description: "Crispy pork with beans, lettuce, and tangy salsa", price: 4.00, category: "Tostadas", topCategory: "Tacos & Wraps", subcategory: "Tostadas", image: carnitasTostada },
  { id: "ts6", name: "Suadero", description: "Tender beef brisket on crispy shell with all the fixings", price: 4.00, category: "Tostadas", topCategory: "Tacos & Wraps", subcategory: "Tostadas", image: suaderoTostada },
  { id: "ts7", name: "Enchilada", description: "Spicy pork with cool toppings for perfect balance", price: 4.00, category: "Tostadas", topCategory: "Tacos & Wraps", subcategory: "Tostadas", image: enchiladaTostada },
  { id: "ts8", name: "Longaniza", description: "Savory sausage with fresh vegetables and cream", price: 4.00, category: "Tostadas", topCategory: "Tacos & Wraps", subcategory: "Tostadas", image: longanizaTostada },
  { id: "ts9", name: "Bistec", description: "Grilled steak on crunchy tortilla, simple perfection", price: 4.00, category: "Tostadas", topCategory: "Tacos & Wraps", subcategory: "Tostadas", image: bistecTostada },
  { id: "ts10", name: "Pollo", description: "Shredded chicken with fresh toppings and zesty sauce", price: 4.00, category: "Tostadas", topCategory: "Tacos & Wraps", subcategory: "Tostadas", image: polloTostada },
  { id: "ts11", name: "Tinga", description: "Smoky chipotle chicken in tomato sauce, absolutely addictive", price: 4.00, category: "Tostadas", topCategory: "Tacos & Wraps", subcategory: "Tostadas", image: tingaTostada },
  { id: "ts12", name: "Pata de Res", description: "Tender beef foot in rich gelatinous broth, comfort food", price: 4.00, category: "Tostadas", topCategory: "Tacos & Wraps", subcategory: "Tostadas", image: pataTostada },
  { id: "ts13", name: "Picadillo de Res", description: "Hearty beef stew with potatoes on crispy base", price: 4.00, category: "Tostadas", topCategory: "Tacos & Wraps", subcategory: "Tostadas", image: picadilloTostada },
  { id: "ts14", name: "Vegetariana", description: "Fresh beans, lettuce, tomato, cheese, and avocado", price: 4.00, category: "Tostadas", topCategory: "Tacos & Wraps", subcategory: "Tostadas", image: vegetarianaTostada },
  { id: "ts15", name: "De Camarones", description: "Plump shrimp with citrus and fresh vegetables", price: 4.00, category: "Tostadas", topCategory: "Tacos & Wraps", subcategory: "Tostadas", image: camaronesTostada },
  { id: "ts16", name: "Cecina", description: "Smoky salted beef on crispy tortilla perfection", price: 4.00, category: "Tostadas", topCategory: "Tacos & Wraps", subcategory: "Tostadas", image: cecinaTostada },
  { id: "ts17", name: "Arabe", description: "Middle Eastern-inspired pork with unique spices", price: 4.00, category: "Tostadas", topCategory: "Tacos & Wraps", subcategory: "Tostadas", image: arabeTostada },
  ...
  { id: "s2", name: "Pozole Grande", description: "Large bowl of traditional hominy soup, pure comfort", price: 10.00, category: "Sopas", topCategory: "Soups", subcategory: "Traditional Soups", image: pozole },
  ...
  { id: "p5", name: "Chuleta de Puerco", description: "Juicy grilled pork chop with rice, beans, and salad", price: 16.00, category: "Main Platillos", topCategory: "Main Dishes", subcategory: "Grilled Meats", image: chuletaPuerco },
  { id: "p6", name: "Bistec Encebollado", description: "Tender steak smothered in caramelized onions", price: 17.00, category: "Main Platillos", topCategory: "Main Dishes", subcategory: "Grilled Meats", image: bistecEncebollado },
  { id: "p7", name: "Bistec a la Mexicana", description: "Steak sautéed with tomatoes, jalapeños, and onions", price: 17.00, category: "Main Platillos", topCategory: "Main Dishes", subcategory: "Grilled Meats", image: bistecMexicana },
  { id: "p8", name: "Bistec de Pollo a la Mexicana", description: "Chicken breast with tomatoes, peppers, and bold spices", price: 16.00, category: "Main Platillos", topCategory: "Main Dishes", subcategory: "Grilled Meats", image: polloMexicana },
  ...
  { id: "p17", name: "Pechuga Asada", description: "Perfectly grilled chicken breast with fresh sides", price: 16.00, category: "Main Platillos", topCategory: "Main Dishes", subcategory: "Grilled Meats", image: pechugaAsada },
  { id: "p18", name: "Carne Azada", description: "Charred grilled steak with smoky flavor and tender texture", price: 17.00, category: "Main Platillos", topCategory: "Main Dishes", subcategory: "Grilled Meats", image: carneAsadaPlatillo },
  { id: "p19", name: "Carne Enchilada", description: "Chile-marinated pork, grilled to spicy perfection", price: 17.00, category: "Main Platillos", topCategory: "Main Dishes", subcategory: "Grilled Meats", image: carneEnchiladaPlatillo },
  { id: "p20", name: "Camarones a la Diabla", description: "Shrimp in fiery red chile sauce, not for the faint of heart", price: 19.00, category: "Main Platillos", topCategory: "Main Dishes", subcategory: "Seafood", image: camaronesDiabla },
  { id: "p21", name: "Camarones al Mojo de Ajo", description: "Succulent shrimp in rich garlic butter sauce", price: 19.00, category: "Main Platillos", topCategory: "Main Dishes", subcategory: "Seafood", image: camaronesMojo },
  { id: "p22", name: "Camarones Empanizados", description: "Crispy breaded shrimp, golden and delicious", price: 19.00, category: "Main Platillos", topCategory: "Main Dishes", subcategory: "Seafood", image: camaronesEmpanizados },
  ...
  // Kids Menu
  { id: "k1", name: "French Fries", description: "Classic crispy golden fries", price: 4.00, category: "Kids Menu", topCategory: "Kids & Sides", subcategory: "Kids Menu", image: frenchFries },
  { id: "k2", name: "Chicken Nuggets", description: "Golden crispy chicken nuggets", price: 12.00, category: "Kids Menu", topCategory: "Kids & Sides", subcategory: "Kids Menu", image: chickenNuggets },
  { id: "k3", name: "Chicken Tenders & Fries", description: "Crispy chicken tenders served with golden fries", price: 12.00, category: "Kids Menu", topCategory: "Kids & Sides", subcategory: "Kids Menu", image: chickenTendersFries },
  { id: "k4", name: "Nuggets & Fries Meal", description: "Chicken nuggets with a side of crispy fries", price: 12.00, category: "Kids Menu", topCategory: "Kids & Sides", subcategory: "Kids Menu", image: nuggetsFries },
  { id: "k5", name: "Chicken Quesadilla & Fries", description: "Cheesy chicken quesadilla with golden fries", price: 12.00, category: "Kids Menu", topCategory: "Kids & Sides", subcategory: "Kids Menu", image: quesadillaFries },
  { id: "k6", name: "Salchipapas", description: "Sliced hot dogs with crispy fries, a kids favorite", price: 12.00, category: "Kids Menu", topCategory: "Kids & Sides", subcategory: "Kids Menu", image: salchipapas },
  { id: "k7", name: "Fried Chicken & Fries", description: "Crispy fried chicken wings with fries - Choose your flavor: Mango Habanero, Buffalo, or BBQ", price: 12.00, category: "Kids Menu", topCategory: "Kids & Sides", subcategory: "Kids Menu", image: friedChickenFries },

  // Side Orders
  { id: "e1", name: "Quesillo", description: "Oaxacan string cheese, creamy and mild", price: 1.00, category: "Side Orders", topCategory: "Kids & Sides", subcategory: "Sides & Extras", image: quesillo },
  { id: "e2", name: "Pico de Gallo", description: "Fresh chopped salsa with tomato, onion, and cilantro", price: 1.00, category: "Side Orders", topCategory: "Kids & Sides", subcategory: "Sides & Extras", image: picoDeGallo },
  { id: "e3", name: "Guacamole", description: "Creamy avocado dip with lime and seasonings", price: 1.00, category: "Side Orders", topCategory: "Kids & Sides", subcategory: "Sides & Extras", image: guacamole },
  { id: "e4", name: "Nopales", description: "Grilled cactus paddles, tender and tangy", price: 1.00, category: "Side Orders", topCategory: "Kids & Sides", subcategory: "Sides & Extras", image: nopales },
  { id: "e5", name: "Crema", description: "Mexican sour cream, rich and tangy", price: 1.00, category: "Side Orders", topCategory: "Kids & Sides", subcategory: "Sides & Extras", image: crema },

  // Fines de Semana (Weekend Specials)
  { id: "w1", name: "Barbacoa", description: "Traditional pit-barbecued meat, slow-cooked to perfection", price: 18.00, category: "Fines de Semana", topCategory: "Main Dishes", subcategory: "Weekend Specials", image: barbacheraTaco },
  { id: "s3", name: "Pancita", description: "Savory beef tripe soup with aromatic spices", price: 7.00, category: "Fines de Semana", topCategory: "Soups", subcategory: "Weekend Specials", image: pancita },
  ...
  // Bebidas (Drinks)
  { id: "d1", name: "Aguas Frescas Med", description: "Refreshing fruit water, naturally sweetened", price: 3.00, category: "Bebidas", topCategory: "Beverages", subcategory: "Fresh Drinks", image: aguasFrescas },
  { id: "d2", name: "Aguas Frescas Gde", description: "Large refreshing fruit water in seasonal flavors", price: 4.00, category: "Bebidas", topCategory: "Beverages", subcategory: "Fresh Drinks", image: aguasFrescas },
  { id: "d3", name: "Licuados Chocomilk Reg", description: "Creamy chocolate milk smoothie, rich and satisfying", price: 4.99, category: "Bebidas", topCategory: "Beverages", subcategory: "Smoothies", image: licuadoChocolate },
  { id: "d4", name: "Licuados Chocomilk Large", description: "Large chocolate smoothie, indulgent and delicious", price: 7.00, category: "Bebidas", topCategory: "Beverages", subcategory: "Smoothies", image: licuadoChocolate },
  { id: "d5", name: "Licuados Mamey Reg", description: "Tropical mamey smoothie, creamy and exotic", price: 4.99, category: "Bebidas", topCategory: "Beverages", subcategory: "Smoothies", image: licuadoMamey },
  { id: "d6", name: "Licuados Mamey Large", description: "Large mamey smoothie, uniquely delicious", price: 7.00, category: "Bebidas", topCategory: "Beverages", subcategory: "Smoothies", image: licuadoMamey },
  { id: "d7", name: "Licuados Fresa Reg", description: "Fresh strawberry smoothie, sweet and refreshing", price: 4.99, category: "Bebidas", topCategory: "Beverages", subcategory: "Smoothies", image: licuadoFresa },
  { id: "d8", name: "Licuados Fresa Large", description: "Large strawberry smoothie, berry delicious", price: 7.00, category: "Bebidas", topCategory: "Beverages", subcategory: "Smoothies", image: licuadoFresa },
  { id: "d9", name: "Licuados Platano Reg", description: "Creamy banana smoothie, naturally sweet", price: 4.99, category: "Bebidas", topCategory: "Beverages", subcategory: "Smoothies", image: licuadoPlatano },
  { id: "d10", name: "Licuados Platano Large", description: "Large banana smoothie, smooth and satisfying", price: 7.00, category: "Bebidas", topCategory: "Beverages", subcategory: "Smoothies", image: licuadoPlatano },
  { id: "d11", name: "Licuados Mango Reg", description: "Tropical mango smoothie, vibrant and refreshing", price: 4.99, category: "Bebidas", topCategory: "Beverages", subcategory: "Smoothies", image: licuadoMango },
  { id: "d12", name: "Licuados Mango Large", description: "Large mango smoothie, taste of the tropics", price: 7.00, category: "Bebidas", topCategory: "Beverages", subcategory: "Smoothies", image: licuadoMango },
  { id: "d13", name: "Licuados Papaya Reg", description: "Smooth papaya smoothie, tropical and healthy", price: 4.99, category: "Bebidas", topCategory: "Beverages", subcategory: "Smoothies", image: licuadoPapaya },
  { id: "d14", name: "Licuados Papaya Large", description: "Large papaya smoothie, refreshing and nutritious", price: 7.00, category: "Bebidas", topCategory: "Beverages", subcategory: "Smoothies", image: licuadoPapaya },
  ...
  { id: "d18", name: "Refrescos Mexicanos", description: "Authentic Mexican sodas in glass bottles", price: 3.00, category: "Bebidas", topCategory: "Beverages", subcategory: "Sodas", image: refrescosMexicanos },
  { id: "d19", name: "Sodas del Pais", description: "Classic American soft drinks", price: 2.00, category: "Bebidas", topCategory: "Beverages", subcategory: "Sodas", image: sodas },

  // Postres (Desserts)
  { id: "de1", name: "Pastel de Tres Leches", description: "Heavenly sponge cake soaked in three milks, incredibly moist", price: 5.00, category: "Postres", topCategory: "Desserts", subcategory: "Traditional Desserts", image: tresLeches },
  { id: "de2", name: "Gelatinas", description: "Colorful layered gelatin desserts, light and refreshing", price: 3.00, category: "Postres", topCategory: "Desserts", subcategory: "Traditional Desserts", image: gelatinas },
  { id: "de3", name: "Flan Napolitano", description: "Silky caramel custard, smooth and decadent", price: 4.00, category: "Postres", topCategory: "Desserts", subcategory: "Traditional Desserts", image: flan },
  { id: "de4", name: "Cremitas", description: "Sweet cream desserts in assorted flavors", price: 3.00, category: "Postres", topCategory: "Desserts", subcategory: "Traditional Desserts", image: cremitas },
];
